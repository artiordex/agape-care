 ...
 */
export const getCarePlansContract = {
  method: 'GET' as const,
  path: '/care/plans',
  query: z.object({
 ...
 * 신규 케어 플랜 및 목표 수립
 */
export const createCarePlanContract = {
 ...
 * 입소자 또는 보호자 상담 기록 등록
 */
export const createConsultationContract = {
  method: 'POST' as const,
 ...
 */
export const getIncidentsContract = {
  method: 'GET' as const,
  path: '/care/incidents',
  query: z.object({
 ...
 */
export const updateIncidentStatusContract = {
 ...
 */
export const getCareTasksContract = {
  method: 'GET' as const,
  path: '/care/tasks',
  query: z.object({
 ...
 * 케어 업무 수행 상태 업데이트
 */
export const updateCareTaskStatusContract = {
  method: 'PATCH' as const,
...
// Contract 타입 추출
export type GetCarePlansContract = typeof getCarePlansContract;
export type CreateCarePlanContract = typeof createCarePlanContract;
export type CreateConsultationContract = typeof createConsultationContract;
export type GetIncidentsContract = typeof getIncidentsContract;
export type UpdateIncidentStatusContract = typeof updateIncidentStatusContract;
export type GetCareTasksContract = typeof getCareTasksContract;
export type UpdateCareTaskStatusContract = typeof updateCareTaskStatusContract;
