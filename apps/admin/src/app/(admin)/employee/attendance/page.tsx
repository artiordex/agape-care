/**
 * Description : page.tsx - ?? employee/attendance ??? UI ????
 * Author : Shiwoo Min
 * Date : 2026-02-18
 */
...
export default function AttendanceManagementPage() {
  ...
  const handleExport = () => {
    ...
    const filename = `Agape_Attendance_${activeTab === 'daily' ? dateFilter : (dateFilter as string).substring(0, 7)}`;
        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="border border-gray-300 bg-white shadow-xl">
            ...
            <div className="p-0">
              ...
              {activeTab === 'daily' && <DailyAttendanceTable records={attendanceRecords} />}
              {activeTab === 'monthly' && <MonthlyAttendanceTable summaryData={monthlySummary} />}
            </div>
