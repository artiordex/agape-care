/**
 * Description : page.tsx - 예약 발송 관리 (Agape Care ERP Theme)
 * Author : Shiwoo Min
 * Date : 2026-02-18
 */
...
export default function ScheduledNotificationPage() {
  ...
  return (
    <div className="flex h-screen flex-col gap-4 overflow-hidden bg-[#f0f2f5] p-4 font-sans text-gray-800 antialiased">
      {/* 1. 상단 인디케이터 & 메뉴 */}
      <div className="flex flex-col justify-between gap-4 rounded-sm border-b border-gray-300 bg-white p-4 shadow-sm md:flex-row md:items-center">
        <div className="flex items-center gap-3">
          <div className="rounded-lg bg-[#5C8D5A] p-2.5 text-white shadow-md">
            <i className="ri-calendar-schedule-line text-xl"></i>
          </div>
          <div>
            <h1 className="text-lg font-black leading-tight text-gray-900">예약 발송 관리</h1>
            <p className="text-[11px] font-bold uppercase text-[#5C8D5A]">Scheduled Notification Management</p>
          </div>
        </div>
