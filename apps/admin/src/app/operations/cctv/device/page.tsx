      ...
      <div className="mb-6">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">CCTV 장치 정보 및 운영 현황을 관리합니다</p>
          </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-gray-900">{devices.length}대</p>
              </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="border-b border-gray-200 bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">장치명</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">설치장소</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">보관기간</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">저장유형</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">담당자</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-600">설치일</th>
        ...
        >
          ...
          >
            <div className="sticky top-0 flex items-center justify-between bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-4">
              <h2 className="text-xl font-bold text-white">{isEditMode ? 'CCTV 장치 수정' : 'CCTV 장치 등록'}</h2>
              <button
                onClick={() => setShowDeviceModal(false)}
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">장치명 *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">설치장소 *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">촬영보관기간 (일) *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">저장유형 *</label>
                  <select
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">작동상태 *</label>
                  <select
