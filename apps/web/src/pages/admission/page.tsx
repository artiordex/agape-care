...
export default function AdmissionPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: '장기요양등급에 따라 본인부담금이 다르며, 기초생활수급자는 감면 혜택이 있습니다. 자세한 비용은 비용안내 페이지를 참고해주세요.'
    },
    {
    ...
    },
    {
      ...
      answer: '협력 병원과 연계하여 정기 건강검진 및 응급 상황 시 즉시 대응합니다. 간호사가 상주하여 건강 관리를 지원합니다.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white pb-16 lg:pb-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm mb-6">
              <i className="ri-file-list-3-line text-[#5C8D5A] text-xl"></i>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-md border border-gray-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-bold text-gray-900 mb-2">서류 준비 안내</h4>
                <p className="text-gray-600 leading-relaxed">
                  모든 서류는 발급일로부터 3개월 이내의 것으로 준비해주세요. 
                  서류 준비가 어려우신 경우 시설에서 도움을 드릴 수 있습니다. 
                  자세한 사항은 상담 시 문의해주세요.
                </p>
              </div>
            </div>
      ...
      {/* 입소 준비물 */}
      <section id="preparation" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ref={ref3}
            initial={{ opacity: 0, y: 30 }}
          ...
          <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-bold text-gray-900 mb-2">준비물 팁</h4>
                <p className="text-gray-600 leading-relaxed">
                  모든 의류와 개인 물품에는 이름표를 부착해주세요. 
                  귀중품은 최소한으로 가져오시고, 필요시 시설에서 안전하게 보관해드립니다. 
      ...
      {/* 생활 규칙 */}
      <section id="rules" className="py-20 bg-gradient-to-br from-teal-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ref={ref4}
            initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {lifeRules.map((rule, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-50 to-amber-50 flex items-center justify-center flex-shrink-0">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              <details
                key={index}
                className="group bg-gradient-to-br from-teal-50 to-amber-50 rounded-xl shadow-md hover:shadow-lg transition-all"
              >
                <summary className="flex items-center justify-between px-6 py-5 cursor-pointer list-none">
                  <div className="flex items-start gap-4 flex-1">
                    <div className="w-8 h-8 rounded-full bg-[#5C8D5A] flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-bold text-sm">Q</span>
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 flex-1">{faq.question}</h3>
                  </div>
                  <i className="ri-arrow-down-s-line text-2xl text-gray-600 group-open:rotate-180 transition-transform flex-shrink-0"></i>
                </summary>
