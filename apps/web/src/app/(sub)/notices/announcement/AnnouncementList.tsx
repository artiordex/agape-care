          ...
          notices.map(notice => (
            ...
            >
              ...
              <div className="mb-2 flex items-start gap-2">
                {notice.isPinned && <i className="ri-pushpin-fill mt-0.5 flex-shrink-0 text-[#5C8D5A]" />}
                <h3 className="line-clamp-2 flex-1 text-sm font-semibold text-gray-900">{notice.title}</h3>
                {notice.isNew && (
                  <span className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white">
                    N
                  </span>
              ...
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <span
                  className={`inline-block rounded-full border px-2 py-0.5 font-semibold ${
                    notice.category === '중요'
                      ? 'border-red-200 bg-red-50 text-red-600'
                      : notice.category === '행사'
                        ? 'border-blue-200 bg-blue-50 text-blue-600'
