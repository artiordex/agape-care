...
export default function VisitContactSection() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      isForm: true, // 클릭 시 모달을 띄우기 위한 플래그
    },
  ];
    ...
    <section className="bg-gradient-to-br from-gray-50 to-[#5C8D5A]/5 py-24 font-['Pretendard']">
      <div className="mx-auto max-w-[90%] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">면회 문의하기</h2>
        </motion.div>
